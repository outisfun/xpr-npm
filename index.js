...
const XPRCustomCursor = require('xpr-custom-cursor/script.js');
var css = require('bundle.css');

var XPR = {};

module.exports = XPR;

},{"bundle.css":20,"xpr-custom-cursor/script.js":2}],2:[function(require,module,exports){
var gsap = require('gsap');
var _ = require('lodash');
require('browsernizr/test/touchevents');
var Modernizr = require('browsernizr');

function XPRCustomCursor(container, opts) {
  this.DOM = {
    container: container || document.querySelector('body')
  };

  var _defaultOpts = {
    markup: '<span>add markup!</span>',
    styles: {
      position: 'fixed',
      pointerEvents: 'none',
...
XPRCustomCursor.prototype.init = function() {
  this.buildMarkup();
  this.applyStyles();
  this.initEvents();
}

XPRCustomCursor.prototype.buildMarkup = function() {
  this.DOM.el = document.createElement('div');
  this.DOM.el.classList.add('xpr-custom-cursor');
  this.DOM.el.innerHTML = this.opts.markup;

  this.DOM.container.appendChild(this.DOM.el);
}

XPRCustomCursor.prototype.applyStyles = function() {
  var _styles = {};
  _.forOwn(this.opts.styles, function(value, styleAttr) { _styles[styleAttr] = value; });
  TweenLite.set(this.DOM.el, _styles);
}

XPRCustomCursor.prototype.initEvents = function() {
  var _w = this.DOM.el.offsetWidth;
  var _h = this.DOM.el.offsetHeight;
  document.addEventListener("mousemove", e => {
    cx = e.clientX;
    cy = e.clientY;
    TweenLite.to(this.DOM.el, this.opts.speed, {
      x: (cx - _w/2) + 'px',
      y: (cy - _h/2) + 'px',
      ease: Power2.easeOut
    });
...
module.exports = XPRCustomCursor;

},{"browsernizr":4,"browsernizr/test/touchevents":19,"gsap":21,"lodash":22}],3:[function(require,module,exports){
'use strict';
...
},{"./lib/Modernizr":5,"./lib/ModernizrProto":6,"./lib/classes":7,"./lib/setClasses":16,"./lib/testRunner":17}],5:[function(require,module,exports){
...
},{"./ModernizrProto.js":6,"./injectElementWithStyles.js":11}],15:[function(require,module,exports){
var ModernizrProto = require('./ModernizrProto.js');
  /**
...
},{"./ModernizrProto.js":6}],16:[function(require,module,exports){
...
},{"./Modernizr.js":5,"./docElement.js":9,"./isSVG.js":13}],17:[function(require,module,exports){
var tests = require('./tests.js');
var Modernizr = require('./Modernizr.js');
...
},{"./Modernizr.js":5,"./classes.js":7,"./is.js":12,"./tests.js":18}],18:[function(require,module,exports){
...
},{"./../lib/Modernizr.js":5,"./../lib/mq.js":14,"./../lib/prefixes.js":15}],20:[function(require,module,exports){
var css = ""; (require("browserify-css").createStyle(css, { "href": "node_modules/bundle.css" }, { "insertAt": "bottom" })); module.exports = css;
